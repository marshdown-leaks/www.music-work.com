...
function ald_add_submenu_page() {
	add_submenu_page( 
		'options-general.php', 
		'Load More Anything Settings page by ASRCODER™', 
		'Load More Anything', 
		'manage_options', 
		'ald_setting', 
...
function register_ald_plugin_settings() {
	...
	register_setting( 'ald-plugin-settings-group', 'asr_ald_css_classa' );
	...
	register_setting( 'ald-plugin-settings-group', 'asr_ald_css_classb' );	
	...
	register_setting( 'ald-plugin-settings-group', 'asr_ald_css_classc' );
	...
	register_setting( 'ald-plugin-settings-group', 'asr_ald_css_classd' );
}
