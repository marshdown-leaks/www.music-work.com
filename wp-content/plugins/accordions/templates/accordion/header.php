...
if ( ! defined('ABSPATH')) exit;  // if direct access 
	...
	if(!empty($accordions_content_title_toogled[$index])){
		
		$title_toogled = $accordions_content_title_toogled[$index];
		}
	else{
		$title_toogled = '';
		}
	...
	?>
    <div post_id="<?php echo $post_id; ?>" header_id="header-<?php echo $index; ?>" id="header-<?php echo $index; ?>" style="" class="accordions-head head<?php echo $index; ?>" toogle-text="<?php echo $title_toogled; ?>" main-text="<?php echo $accordions_title; ?>" >
    <?php
